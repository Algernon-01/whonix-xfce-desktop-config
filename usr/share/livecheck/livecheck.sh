...
if grep -qs "boot=live" /proc/cmdline; then
   ...
   if [ -n "$(lsblk /dev/disk/by-uuid/26ada0c0-1165-4098-884d-aafd2220c2c6 -o RO | grep "1")" ]; then
      ...
      echo "<click>bash /home/user/.tb/tor-browser/Browser/start-tor-browser --allow-remote https://whonix.org/wiki/Whonix_Live</click>"
      echo "<txtclick>bash /home/user/.tb/tor-browser/Browser/start-tor-browser --allow-remote https://whonix.org/wiki/Whonix_Live</txtclick>" 
   else
